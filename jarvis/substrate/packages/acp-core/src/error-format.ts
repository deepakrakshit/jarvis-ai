...
const STRUCTURED_AUTH_MARKER_PREFIX = ";__jarvis_structured_auth_redacted_";

// Minimal fallback for standalone or unwired ACP core. JARVIS injects canonical
...
const SECRET_PATTERNS: RegExp[] = [
  ...
  /(?:X-JARVIS-Token|x-pomerium-jwt-assertion|X-Api-Key|X-Auth-Token)\s*[:=]\s*([^\s"',;]+)/gi,
...
export { stringifyNonErrorCause } from "@jarvis/normalization-core/error-coercion";
