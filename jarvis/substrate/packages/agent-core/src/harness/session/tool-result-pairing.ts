...
export const SYNTHETIC_MISSING_TOOL_RESULT_DETAIL_KEY = "jarvisSyntheticMissingToolResult";
export const DEFAULT_MISSING_TOOL_RESULT_TEXT =
  "[jarvis] missing tool result in session history; inserted synthetic error result for transcript repair.";
