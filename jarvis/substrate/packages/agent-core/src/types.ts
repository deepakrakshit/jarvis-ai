...
export interface InternalToolBatchCall {
  ...
  args: unknown;
  /** Resolved tool identity for JARVIS-owned argument canonicalization. */
  tool?: AgentTool;
}
...
/** Context for JARVIS-owned whole-batch tool admission. */
...
/** Result of JARVIS-owned whole-batch tool admission. */
...
export interface AgentLoopConfig extends SimpleStreamOptions {
  ...
  /** @internal JARVIS-owned batch admission. Not a plugin or session SDK hook. */
  beforeToolBatch?: (
 ...
 * from jarvis/plugin-sdk/llm to detect support for a concrete model.
 */
