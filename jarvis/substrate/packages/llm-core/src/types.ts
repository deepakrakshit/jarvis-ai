...
/** Provider API families with first-class request/stream adapters in JARVIS. */
...
/** Image-generation API families with first-class adapters in JARVIS. */
...
/** Image provider ids with first-class adapters in JARVIS. */
...
export interface Model<TApi extends Api = Api> {
  ...
  reasoning: boolean;
  /**
   * Maps JARVIS thinking levels to provider/model-specific values.
