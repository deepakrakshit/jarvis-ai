...
type ExecToolConfig = NonNullable<NonNullable<JarvisConfig["tools"]>["exec"]>;
...
type HandleSystemRunInvokeOptions = {
  ...
  getRuntimeConfig?: () => JarvisConfig;
  autoReviewer?: ExecAutoReviewer;
  commitExecAuthorization?: typeof commitExecAuthorizationLocked;
};

async function loadSystemRunConfig(opts: HandleSystemRunInvokeOptions): Promise<JarvisConfig> {
