...
import {
  ...
  type JarvisPluginApiWithoutFacades,
} from "../plugins/api-facades.js";
import type { JarvisPluginApi } from "./plugin-runtime.js";

/** Partial plugin API overrides accepted by the SDK test helper. */
export type TestPluginApiInput = Partial<JarvisPluginApi>;

/** Create a minimal plugin API object for plugin-sdk contract and unit tests. */
export function createTestPluginApi(api: TestPluginApiInput = {}): JarvisPluginApi {
  ...
  const mergedApi = {
    ...
    config: {},
    runtime: {} as JarvisPluginApi["runtime"],
    ...
    on() {},
    ...flatApi,
  } satisfies JarvisPluginApiWithoutFacades;
