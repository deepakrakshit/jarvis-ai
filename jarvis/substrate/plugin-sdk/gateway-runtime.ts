...
export { redactSensitiveUrlLikeString } from "@jarvis/net-policy/redact-sensitive-url";
...
// Compatibility for @tencent-connect/jarvis-qqbot@2.0.3. Remove after the pinned
