...
type EnsureAuthProfileStore =
  typeof import("@jarvis/plugin-sdk/provider-auth").ensureAuthProfileStore;
type ListProfilesForProvider =
  typeof import("@jarvis/plugin-sdk/provider-auth").listProfilesForProvider;
...
function installSharedAuthProfileStoreHooks(state: { authStore: AuthProfileStore }) {
  beforeEach(() => {
    vi.doMock("@jarvis/plugin-sdk/provider-auth", async () => {
      const actual = await vi.importActual<typeof import("@jarvis/plugin-sdk/provider-auth")>(
        "@jarvis/plugin-sdk/provider-auth",
      );
      return {
        ...actual,
