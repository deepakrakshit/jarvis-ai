...
/** Install JARVIS-owned loop control without adding a plugin-facing Agent option. */
...
/** Attach JARVIS-owned two-phase execution without changing the public AgentTool shape. */
