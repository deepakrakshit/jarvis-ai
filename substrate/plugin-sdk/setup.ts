...
// Registry readers (2026-07-22): @nodeskai/feishu, jarvis-channel-whatsapp-official,
// jarvis-vk, jarvis-ndr, moltbot-channel-feishu, @kagura-agent/jarvis-zulip,
// @jeik/dingtalk-connector, @xzq-xu/feishu, @dingtalk-real-ai/dingtalk-connector,
// @jarvis-vk/vk, yzw-dingtalk-connector, and jarvis-channel-zulip.
...
export type {
  ...
  WizardProgress,
  WizardPrompter,
  // Registry reader (2026-07-22): @ama2/jarvis-channel.
  WizardSelectParams,
...
// Registry readers (2026-07-22): @cyzlmh/jarvis-sms, @spicerhome/claw-messenger,
// @chatu-ai/webhub, @rowger_go/chatu, and @emotion-machine/claw-messenger.
export { normalizeE164 } from "../utils.js";
// Registry readers (2026-07-22): jarvis-rcs, @woowonjae/rol-websocket-channel,
// jarvis-swarm-layer, rol-websocket-channel, @clawling/clawchat-plugin-jarvis,
// @workclaw/jarvis-workclaw, clawspec, and @privateclaw/privateclaw.
...
export {
  ...
  // Registry reader (2026-07-22): @lansenger-pm/jarvis-lansenger-channel.
  ...
  // Registry reader (2026-07-22): jarvis-channel-xiaozhu.
  resolveSetupAccountId,
  runSingleChannelSecretStep,
  setSetupChannelEnabled,
  // Registry readers (2026-07-22): jarvis-vk and @jarvis-vk/vk.
